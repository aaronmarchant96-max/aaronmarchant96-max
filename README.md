...
REI.ai is the flagship product: a cost-aware routing and reasoning system that classifies prompts locally, routes them to the cheapest capable model, and keeps the reasoning traceable. As of August 4, 2026, I’ve built six production systems with 812+ commits total across the portfolio repos I can verify here.
...
- **June 2026**: Shipped **6 production systems** across the public portfolio
- **Ongoing**: Multi-model validation and review-first development

### Key Stats
- **812+ commits** as of August 4, 2026 across the portfolio repos I can verify here
